        ...
        return (
            <div className={classnames('HeaderComponent', className)}>
                <Navbar collapseOnSelect>
                    ...
                    <Navbar.Collapse>
                        <Nav>
                            <NavItem eventKey={1} href="#">Rules</NavItem>
                            <NavItem eventKey={1} href="#">Competitions</NavItem>
                        </Nav>
                        <Nav className="no-divider" pullRight>
                            {this.props.user && <NavDropdown title={accountIcon(this.props.user)} id="basic-nav-dropdown-1">
                                <MenuItem onClick={() => this.props.editorShow('memory')}>Rules</MenuItem>
                                <MenuItem onClick={() => this.props.editorShow('memory')}>Rules</MenuItem>
                                <MenuItem divider/>
